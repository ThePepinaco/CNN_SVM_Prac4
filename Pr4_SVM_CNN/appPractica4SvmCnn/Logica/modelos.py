...
def prediccionSVM(imagen):
        ...
        SVM_Predict=cargarObjeto("ModelosML/SVM")
        prediccion_SVM = SVM_Predict.predict(imagen_flatten.reshape(1, -1))
        claseNombre= clases[prediccion_SVM[0]]
        resultado = f"Se predijo que es la clase: {claseNombre}"
        return resultado


def prediccionCNN(imagen):
    # ImagenAplanada
    CNN_Predict = cargarNN("ModelosML/CNN")
